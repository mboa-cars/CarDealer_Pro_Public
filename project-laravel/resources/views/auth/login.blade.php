                ...
                <div class="card border-0 shadow-lg" style="border-radius: 16px; background: white;">
                    <div class="card-body p-4">
                        ...
                        <div class="text-center mb-3">
                            ...
                            <h3 class="fw-bold mb-0" style="color: #333; font-size: 1.8rem;">Login</h3>
                        </div>
                        ...
                        <form method="POST" action="{{ route('login') }}" id="loginForm">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="position-relative">
                                    <input type="password" id="password" name="password" class="form-control modern-input" required autocomplete="current-password" placeholder="Enter your password">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <div class="form-check">
                                    <input type="checkbox" id="remember_me" name="remember" class="form-check-input" style="border-radius: 4px; border: 2px solid #e9ecef;">
                                    <label for="remember_me" class="form-check-label" style="color: #555; font-size: 0.9rem;">
                                        Remember me
                                    </label>
                                </div>
                                @if (Route::has('password.request'))
                                    <a href="{{ route('password.request') }}" class="text-decoration-none" style="color: #F26522; font-size: 0.9rem; font-weight: 600;">
                                        Forgot password?
                                    </a>
                                @endif
                            </div>
                            ...
                            <div class="text-center">
                                ...
                                <a href="{{ route('register') }}" class="text-decoration-none" style="color: #F26522; font-weight: 600;">Click here to signup</a>
                            </div>
                        </form>
                    </div>
                </div>
